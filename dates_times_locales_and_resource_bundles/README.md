...
Take a look at the example into [``Locales`` class](src/date_and_time/Locales.java) class where the method ``printLabelsEnCaResourceBundle()`` print the content of ``Labels_en_CA.java``.
